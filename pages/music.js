      ...
      <div className="flex flex-col items-center justify-center text-center px-8 pt-8 pb-32">
        <div className="max-w-3xl text-left space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl font-bold mb-12">Neurime</h1>
            <h2 className="text-2xl font-semibold mb-4">A Neural Network-Inspired Musical Interface</h2>
          ...
          <iframe title="vimeo-player" src="https://player.vimeo.com/video/50642688?h=45394778e6" width="640" height="360" frameborder="0"    allowfullscreen></iframe>
          </div>

          {/* What is Neurime Section */}
          <div className="space-y-4">
            <h2 className="text-3xl font-bold mb-8 text-accent">What is Neurime?</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm mt-8">
              <h3 className="text-2xl font-bold mb-4 text-accent">Memory & Evolution:</h3>
          ...
          <div className="space-y-4">
            <h2 className="text-3xl font-bold mb-8 text-accent">Why We Built It</h2>
            <div className="flex justify-start mb-6">
              <Image
          ...
          {/* Exhibitions Section */}
          <div className="space-y-4">
            <h2 className="text-3xl font-bold mb-8 text-accent">Exhibitions & Performances</h2>
             {/* Vimeo Video */}
          <div className="w-full aspect-video rounded-lg overflow-hidden">
            <iframe
          ...
          {/* Future Section */}
          <div className="space-y-4">
            <h2 className="text-3xl font-bold mb-8 text-accent">Exploring the Future of Interactive Sound</h2>
            <div className="flex justify-start mb-6">
              <Image
