  ...
  return (
    <div className="flex flex-col items-center justify-center text-black text-center">
      <nav className="p-8 flex flex-wrap justify-center gap-x-8 gap-y-4 max-w-6xl px-4">
        ...
        <Link href="/about" className="text-lg text-black hover:underline">About me</Link>
        ...
        <Link href="https://www.linkedin.com/in/eszterozsvald/" className="text-lg text-accent hover:underline">LinkedIn</Link>
      </nav>
    </div>
  );
};
